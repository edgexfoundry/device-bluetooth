...
public class ProfileStore {
  ...
  // profile
  // object key
  private Map<String, Map<String, BleObject>> objects = new HashMap<>();

  public Map<String, Map<String, BleObject>> getObjects() {
    return objects;
  }
  ...
  public void addDevice(Device device) {
    ...
    Map<String, BleObject> deviceObjects = new HashMap<>();
    for (DeviceObject object: device.getProfile().getDeviceResources()) {
      BleObject BleObject = new BleObject(object);

      PropertyValue value = object.getProperties().getValue();

      deviceObjects.put(object.getName(), BleObject);
